...
public class TrainingAnalysisController {
    ...
    public ApiResponse<AnalysisRequestResponseDto> requestAnalysis(
        ...
        return ApiResponse.success(
                "음성 분석을 요청했습니다.",
                AnalysisRequestResponseDto.from(trainingAnalysisRequestService.requestAnalysis(sessionId, userId))
        );
    }
    ...
    public ApiResponse<AnalysisProgressResponseDto> getAnalysisStatus(
        ...
        return ApiResponse.success(
                "분석 진행 상태를 조회했습니다.",
                AnalysisProgressResponseDto.from(trainingAnalysisRequestService.getStatus(sessionId, userId))
        );
    }
    ...
    public ApiResponse<AnalysisRetryResponseDto> retryAnalysis(
        ...
        return ApiResponse.success(
                "음성 분석을 다시 요청했습니다.",
                AnalysisRetryResponseDto.from(trainingAnalysisRequestService.retry(sessionId, userId))
        );
    }
}
